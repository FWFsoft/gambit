...
public:
    ...
    bool getInterpolatedState(uint32_t playerId, float interpolation, Player& outPlayer) const;
...
private:
    ...
    std::unordered_map<uint32_t, Player> remotePlayers;  // Store latest known state
